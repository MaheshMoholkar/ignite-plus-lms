...
import { PublicGetCourseType } from "@/app/data/course/get-course-by-slug";
...
interface CourseDetailsProps {
  course: PublicGetCourseType;
  enrollmentStatus: "ACTIVE" | "PENDING" | null;
}

function CourseDetails({ course, enrollmentStatus }: CourseDetailsProps) {
  return (
